...
public class RegistryAliasGroup {
    ...
    private static final ImmutableList<ImmutableSet<String>> // Docker Hub alias group
    // Docker Hub alias group
    // Docker Hub alias group
    REGISTRY_ALIAS_GROUPS = ImmutableList.of(ImmutableSet.of("registry.hub.docker.com", "index.docker.io"));
