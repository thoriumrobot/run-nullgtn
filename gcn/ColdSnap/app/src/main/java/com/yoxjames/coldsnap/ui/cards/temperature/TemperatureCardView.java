...
public class TemperatureCardView extends CardView implements BaseColdsnapView<GraphCardViewModel>, FeedCardView {
    ...
    private Format createFormatter(Function<Double, String> inputFunction) {
        return new Format() {

            @Override
            public StringBuffer format(Object obj, StringBuffer toAppendTo, @Nullable() FieldPosition pos) {
