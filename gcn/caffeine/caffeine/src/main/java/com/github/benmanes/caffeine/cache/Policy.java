...
public interface Policy<K, V> {
    ...
    interface Eviction<K, V> {
         ...
         */
        void setMaximum(@NonNegative @Nullable() long maximum);
    ...
    Expiration<K, V> {
         ...
         */
        void setExpiresAfter(@NonNegative @Nullable() long duration, @NonNull TimeUnit unit);
         ...
         */
        @NonNull
        Map<@NonNull K, @NonNull V> oldest(@NonNegative @Nullable() int limit);
         ...
         */
        @NonNull
        Map<@NonNull K, @NonNull V> youngest(@NonNegative @Nullable() int limit);
    }
    ...
    interface VarExpiration<K, V> {
         ...
         */
        void setExpiresAfter(@NonNull K key, @NonNegative @Nullable() long duration, @NonNull TimeUnit unit);
         ...
         * @throws IllegalArgumentException if {@code duration} is negative
         */
        default boolean putIfAbsent(@NonNull K key, @NonNull V value, @NonNegative @Nullable() long duration, @NonNull TimeUnit unit) {
         ...
         */
        default void put(@NonNull K key, @NonNull V value, @NonNegative @Nullable() long duration, @NonNull TimeUnit unit) {
            // This method was added & implemented in version 2.6.0
            throw new UnsupportedOperationException();
        }
