...
interface LocalCache<K, V> extends ConcurrentMap<K, V> {
     ...
     */
    void notifyRemoval(@Nullable K key, @Nullable V value, @Nullable() RemovalCause cause);
     ...
     */
    V getIfPresent(@NonNull Object key, @Nullable() boolean recordStats);
     ...
     */
    V put(@NonNull K key, @NonNull V value, @Nullable() boolean notifyWriter);
     ...
     */
    V compute(@Nullable() K key, @Nullable() BiFunction<? super K, ? super V, ? extends V> remappingFunction, @Nullable() boolean recordMiss, @Nullable() boolean recordLoad);
     ...
     */
    V computeIfAbsent(@Nullable() K key, @Nullable() Function<? super K, ? extends V> mappingFunction, @Nullable() boolean recordStats, @Nullable() boolean recordLoad);
