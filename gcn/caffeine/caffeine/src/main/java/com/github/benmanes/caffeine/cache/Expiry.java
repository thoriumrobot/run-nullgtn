...
public interface Expiry<K, V> {
     ...
     */
    long expireAfterCreate(@NonNull K key, @NonNull V value, @Nullable() long currentTime);
     ...
     * @return the length of time before the entry expires, in nanoseconds
     */
    long expireAfterUpdate(@NonNull K key, @NonNull V value, @Nullable() long currentTime, @NonNegative @Nullable() long currentDuration);
     ...
     * @return the length of time before the entry expires, in nanoseconds
     */
    long expireAfterRead(@NonNull K key, @NonNull V value, @Nullable() long currentTime, @NonNegative @Nullable() long currentDuration);
}
