...
public interface StatsCounter {
     ...
     */
    void recordHits(@NonNegative @Nullable() int count);
     ...
     */
    void recordMisses(@NonNegative @Nullable() int count);
     ...
     */
    void recordLoadSuccess(@NonNegative @Nullable() long loadTime);
     ...
     */
    void recordLoadFailure(@NonNegative @Nullable() long loadTime);
     ...
     */
    default void recordEviction(@NonNegative @Nullable() int weight) {
