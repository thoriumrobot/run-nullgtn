...
abstract class Node<K, V> implements AccessOrder<Node<K, V>>, WriteOrder<Node<K, V>> {
     ...
     */
    @GuardedBy("this")
    public void setWeight(@NonNegative @Nullable() int weight) {
    }
     ...
     */
    @GuardedBy("evictionLock")
    public void setPolicyWeight(@NonNegative @Nullable() int weight) {
    }
     ...
     */
    public void setVariableTime(@Nullable() long time) {
    }
     ...
     */
    public void setQueueType(@Nullable() int queueType) {
        throw new UnsupportedOperationException();
    }
     ...
     */
    public void setAccessTime(@Nullable() long time) {
    }
     ...
     * when the lock is released.
     */
    public void setWriteTime(@Nullable() long time) {
    }
     ...
     */
    public boolean casWriteTime(@Nullable() long expect, @Nullable() long update) {
        throw new UnsupportedOperationException();
    }
