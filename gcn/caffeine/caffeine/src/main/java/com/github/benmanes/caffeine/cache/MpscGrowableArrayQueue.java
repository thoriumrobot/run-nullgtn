...
abstract class BaseMpscLinkedArrayQueue<E> extends BaseMpscLinkedArrayQueueColdProducerFields<E> {
     ...
     */
    protected abstract long availableInQueue(@Nullable() long pIndex, @Nullable() final long cIndex);
     ...
     */
    protected abstract long getCurrentBufferCapacity(@Nullable() long mask);
}
