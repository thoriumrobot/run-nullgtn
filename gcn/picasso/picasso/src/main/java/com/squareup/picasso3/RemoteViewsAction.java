...
abstract class RemoteViewsAction extends Action {
    ...
    RemoteViewsAction(Picasso picasso, Request data, @DrawableRes int errorResId, @NonNull RemoteViewsTarget target, Callback callback) {
        super(picasso, data);
    ...
    static class AppWidgetAction extends RemoteViewsAction {
        ...
        AppWidgetAction(Picasso picasso, Request data, @DrawableRes int errorResId, RemoteViewsTarget target, int[] appWidgetIds, Callback callback) {
    ...
    static class NotificationAction extends RemoteViewsAction {
        ...
        NotificationAction(Picasso picasso, Request data, @DrawableRes int errorResId, RemoteViewsTarget target, int notificationId, Notification notification, String notificationTag, Callback callback) {
            super(picasso, data, errorResId, target, callback);
