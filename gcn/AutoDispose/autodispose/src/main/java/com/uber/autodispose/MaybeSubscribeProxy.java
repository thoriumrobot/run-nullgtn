...
public interface MaybeSubscribeProxy<T> {
     ...
     * @return a {@link Disposable}
     */
    Disposable subscribe(@Nullable() Consumer<? super T> onSuccess);
     ...
     * @return a {@link Disposable}
     */
    Disposable subscribe(@Nullable() Consumer<? super T> onSuccess, @Nullable() Consumer<? super Throwable> onError);
     ...
     * @return a {@link Disposable}
     */
    Disposable subscribe(@Nullable() Consumer<? super T> onSuccess, @Nullable() Consumer<? super Throwable> onError, @Nullable() Action onComplete);

    /**
     * Proxy for {@link Maybe#subscribe(MaybeObserver)}.
     */
    void subscribe(@Nullable() MaybeObserver<? super T> observer);
     ...
     */
    @CheckReturnValue
    <E extends MaybeObserver<? super T>> E subscribeWith(@Nullable() E observer);
     ...
     */
    @CheckReturnValue
    TestObserver<T> test(@Nullable() boolean cancel);
}
