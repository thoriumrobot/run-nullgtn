...
public interface CompletableSubscribeProxy {
     ...
     * @return a {@link Disposable}
     */
    Disposable subscribe(@Nullable() Action action);
     ...
     * @return a {@link Disposable}
     */
    Disposable subscribe(@Nullable() Action action, @Nullable() Consumer<? super Throwable> onError);

    /**
     * Proxy for {@link Completable#subscribe(CompletableObserver)}.
     */
    void subscribe(@Nullable() CompletableObserver observer);
     ...
     */
    @CheckReturnValue
    <E extends CompletableObserver> E subscribeWith(@Nullable() E observer);
     ...
     */
    @CheckReturnValue
    TestObserver<Void> test(@Nullable() boolean cancel);
}
