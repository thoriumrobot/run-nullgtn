...
public interface SingleSubscribeProxy<T> {
     ...
     * @return a {@link Disposable}
     */
    Disposable subscribe(@Nullable() BiConsumer<? super T, ? super Throwable> biConsumer);
     ...
     */
    void subscribe(@Nullable() SingleObserver<? super T> observer);
     ...
     */
    @CheckReturnValue
    <E extends SingleObserver<? super T>> E subscribeWith(@Nullable() E observer);
