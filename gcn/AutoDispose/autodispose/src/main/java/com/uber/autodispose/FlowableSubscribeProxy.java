...
public interface FlowableSubscribeProxy<T> {
     ...
     * @return a {@link Disposable}
     */
    Disposable subscribe(@Nullable() Consumer<? super T> onNext, @Nullable() Consumer<? super Throwable> onError, @Nullable() Action onComplete, @Nullable() Consumer<? super Subscription> onSubscribe);

    /**
     * Proxy for {@link Flowable#subscribe(Subscriber)}.
     */
    void subscribe(@Nullable() Subscriber<? super T> observer);
     ...
     */
    @CheckReturnValue
    <E extends Subscriber<? super T>> E subscribeWith(@Nullable() E observer);
     ...
     */
    @CheckReturnValue
    TestSubscriber<T> test(@Nullable() long initialRequest);
     ...
     */
    @CheckReturnValue
    TestSubscriber<T> test(@Nullable() long initialRequest, @Nullable() boolean cancel);
}
