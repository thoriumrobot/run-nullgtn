...
public class CollapsingAppBarActivity extends AppCompatActivity {
    ...
    // -height ==> 0
    private int mCurrentAppBarOffset;
    ...
    public static class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.ui_recycler_view_horizontal_item, parent, false));
        }
