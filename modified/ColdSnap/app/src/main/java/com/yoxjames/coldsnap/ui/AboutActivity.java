...
public class AboutActivity extends AppCompatActivity {
    ...
    @BindView(R.id.cold_snap_item)
    protected RelativeLayout coldSnap;

    @BindView(R.id.licence_item)
    protected RelativeLayout licence;

    @BindView(R.id.view_source_item)
    protected RelativeLayout viewSource;

    @BindView(R.id.help_item)
    protected RelativeLayout help;
