...
public class LayerEntry {
    ...
    public LayerEntry(Path sourceFile, AbsoluteUnixPath extractionPath, @Nullable FilePermissions permissions) {
        ...
        this.permissions = permissions == null ? Files.isDirectory(sourceFile) ? FilePermissions.DEFAULT_FOLDER_PERMISSIONS : FilePermissions.DEFAULT_FILE_PERMISSIONS : permissions;
    }
    ...
    public boolean equals(Object other) {
        ...
        return sourceFile.equals(otherLayerEntry.sourceFile) && extractionPath.equals(otherLayerEntry.extractionPath) && Objects.equals(permissions, otherLayerEntry.permissions);
    }
