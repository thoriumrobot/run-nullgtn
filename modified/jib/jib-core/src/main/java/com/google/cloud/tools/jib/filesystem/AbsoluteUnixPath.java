...
public class AbsoluteUnixPath {
    ...
    public static AbsoluteUnixPath get(String unixPath) {
        Preconditions.checkArgument(unixPath.startsWith("/"), "Path does not start with forward slash (/): " + unixPath);
    ...
    public static AbsoluteUnixPath fromPath(Path path) {
        ...
        ImmutableList.Builder<String> pathComponents = ImmutableList.builderWithExpectedSize(path.getNameCount());
    ...
    public AbsoluteUnixPath resolve(RelativeUnixPath relativeUnixPath) {
        ImmutableList.Builder<String> newPathComponents = ImmutableList.builderWithExpectedSize(pathComponents.size() + relativeUnixPath.getRelativePathComponents().size());
    ...
    public AbsoluteUnixPath resolve(Path relativePath) {
        Preconditions.checkArgument(relativePath.getRoot() == null, "Cannot resolve against absolute Path: " + relativePath);
