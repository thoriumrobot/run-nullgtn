...
class SingleInstanceTracker extends LeakTracker {
    ...
    SingleInstanceTracker(final Class<?> eventClass, final WeakReferenceGenerator weakReferenceGenerator, final String name) {
    ...
    boolean hasViolation() {
        ...
        return gcIndicatorWeakReference != null && gcIndicatorWeakReference.get() == null && clearInvalidAndGetCount() > MAX_ACTIVE_INSTANCES_ALLOWED;
    }
