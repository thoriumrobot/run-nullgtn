...
public abstract class GenerateAction extends AnAction {
    ...
    private static void createSourceFile(Project project, Generator generator, PsiDirectory directory) {
        PsiFile file = PsiFileFactory.getInstance(project).createFileFromText(String.format("%s" + generator.getFileExtension(), generator.getClassName()), JavaLanguage.INSTANCE, generator.generate());
        directory.add(file);
    }
    ...
    protected void generate(final List<Generator> mainSourceGenerators, final List<Generator> testSourceGenerators) {
        ...
        final Module currentModule = Preconditions.checkNotNull(ModuleUtilCore.findModuleForPsiElement(directory));
        ...
        final PackageWrapper targetPackage = new PackageWrapper(PsiManager.getInstance(project), getPackageName());
            ...
            public void run() {
                CommandProcessor.getInstance().executeCommand(project, new Runnable() {
                    ...
                    public void run() {
                        ...
                        PsiDirectory testDirectory = RefactoringUtil.createPackageDirectoryInSourceRoot(targetPackage, testSourceFolder.getFile());
    ...
    protected final String getPackageName() {
        ...
        final IdeView view = Preconditions.checkNotNull(LangDataKeys.IDE_VIEW.getData(dataContext));
        final PsiDirectory directory = Preconditions.checkNotNull(view.getOrChooseDirectory());
        final PsiPackage psiPackage = Preconditions.checkNotNull(JavaDirectoryService.getInstance().getPackage(directory));
