...
public class GenerateRibAction extends GenerateAction implements GenerateRibDialog.Listener {
    ...
    public void onGenerateClicked(String ribName, boolean createPresenterAndView, boolean isKotlinSelected) {
        final GeneratorPair generators = createPresenterAndView ? Generators.getGeneratorsForRibWithPresenterAndView(getPackageName(), ribName, isKotlinSelected) : Generators.getGeneratorsForRibWithoutPresenterAndView(getPackageName(), ribName, isKotlinSelected);
