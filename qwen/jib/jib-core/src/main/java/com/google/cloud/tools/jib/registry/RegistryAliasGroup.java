...
public class RegistryAliasGroup {
    ...
    private static final // Docker Hub alias group
    ImmutableList<ImmutableSet<String>> // Docker Hub alias group
    REGISTRY_ALIAS_GROUPS = // Docker Hub alias group
    ImmutableList.of(ImmutableSet.of("registry.hub.docker.com", "index.docker.io"));
