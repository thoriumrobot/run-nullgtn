...
public class CSSharedPreferencesImpl implements CSPreferences {
    ...
    private PreferenceModel getPreferenceModel() {
        return PreferenceModel.builder().setThreshold(getThreshold()).setTemperatureFormat(getTemperatureFormat()).setWeatherDataFuzz(getWeatherDataFuzz()).setColdAlarmTime(getColdAlarmTime()).setLocationString(getLocationString()).setCoords(getCoords()).build();
    }
    ...
    public SimpleWeatherLocation getCoords() {
        return SimpleWeatherLocation.create(sharedPreferences.getFloat(LAT, 39.098579f), sharedPreferences.getFloat(LON, -94.582596f));
    }
