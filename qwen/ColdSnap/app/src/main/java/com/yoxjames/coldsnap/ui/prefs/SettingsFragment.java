...
public class SettingsFragment extends PreferenceFragment implements CSPreferencesView {
    ...
    @Inject
    CSPreferencesPresenter presenter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ((ColdSnapApplication) getActivity().getApplicationContext()).getInjector().settingsFragmentSubcomponent(new SettingsFragmentModule(this)).inject(this);
