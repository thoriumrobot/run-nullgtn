...
public class PlantDetailModule {
    ...
    @Provides
    static PlantDetailPresenter providePlantDetailPresenter(PlantDetailMvpView view, PlantService plantService, TemperatureValueAdapter temperatureValueAdapter, ImageService imageService, PlantDetailReducer plantDetailReducer) {
