...
public class SettingsFragmentModule {
    ...
    @Provides
    public CSPreferencesPresenter providePresenter(CSPreferencesView view, CSPreferences csPreferences, TemperatureValueAdapter temperatureValueAdapter, TemperatureFormatter temperatureFormatter) {
