...
public class Image<T extends Layer> {
    ...
    public static class Builder<T extends Layer> {
         ...
         * @return this
         */
        public Builder<T> addEnvironment(Map<String, String> environment) {
            if (environment != null) {
         ...
         * @return this
         */
        public Builder<T> setProgramArguments(List<String> programArguments) {
         ...
         * @return this
         */
        public Builder<T> addExposedPorts(Set<Port> exposedPorts) {
         ...
         * @return this
         */
        public Builder<T> addVolumes(Set<AbsoluteUnixPath> volumes) {
            if (volumes != null) {
         ...
         * @return this
         */
        public Builder<T> addLabels(Map<String, String> labels) {
            if (labels != null) {
         ...
         * @return this
         */
        public Builder<T> setWorkingDirectory(String workingDirectory) {
