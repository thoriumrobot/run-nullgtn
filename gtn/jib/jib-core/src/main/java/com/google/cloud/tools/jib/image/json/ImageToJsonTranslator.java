...
public class ImageToJsonTranslator {
    ...
    @VisibleForTesting
    @Nullable
    static Map<String, Map<?, ?>> portSetToMap(Set<Port> exposedPorts) {
    ...
    @VisibleForTesting
    @Nullable
    static Map<String, Map<?, ?>> volumesSetToMap(Set<AbsoluteUnixPath> volumes) {
     ...
     */
    @Nullable
    private static <E> Map<String, Map<?, ?>> setToMap(Set<E> set, Function<E, String> keyMapper) {
        if (set == null) {
            return null;
        }
