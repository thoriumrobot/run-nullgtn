...
public interface CSPreferences {
    ...
    void setThreshold(@Nullable() Temperature temperature);

    void setFuzz(float fuzz);

    void setCoords(@Nullable() SimpleWeatherLocation simpleWeatherLocation);

    void setLocationString(@Nullable() String locationString);
}
