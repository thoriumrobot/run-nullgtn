...
public abstract class WeatherLocation {
    ...
    public static abstract class Builder {
        ...
        public abstract Builder setPlaceString(@Nullable() String placeString);

        public abstract Builder setLat(@Nullable() double lat);

        public abstract Builder setLon(@Nullable() double lon);
