...
public abstract class ForecastHour {
    ...
    public static abstract class Builder {
        ...
        public abstract Builder hour(@Nullable() Instant hour);

        public abstract Builder temperature(@Nullable() Temperature temperature);

        public abstract Builder windspeed(@Nullable() Windspeed windspeed);
