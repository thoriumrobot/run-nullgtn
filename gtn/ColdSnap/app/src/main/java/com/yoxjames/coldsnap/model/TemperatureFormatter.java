...
public interface TemperatureFormatter {
     ...
     */
    String format(@Nullable() Temperature temperature);
     ...
     */
    String formatFuzz(@Nullable() double fuzzKelvins);

    String formatTemperatureScale(@TemperatureFormat @Nullable() int temperatureScale);
}
