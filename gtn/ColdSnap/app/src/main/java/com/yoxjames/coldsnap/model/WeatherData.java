...
public abstract class WeatherData {
    ...
    public abstract static class Builder {
        ...
        public abstract Builder syncInstant(@Nullable() Instant syncInstant);

        public abstract Builder forecastHours(@Nullable() List<ForecastHour> forecastHours);

        public abstract Builder weatherLocation(@Nullable() WeatherLocation weatherLocation);
