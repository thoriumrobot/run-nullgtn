...
public class ColdAlarm extends BroadcastReceiver implements ColdAlarmView {
    ...
    private void displayThresholdMessage(Context context, String tonightFormatted, String thresholdFormatted) {
        ...
        NotificationCompat.Builder //.setSmallIcon(R.drawable.cold_alarm_icon)
        mBuilder = new NotificationCompat.Builder(context).setContentTitle("ColdSnap: Cold Warning").setContentText("Tonight's low " + tonightFormatted + " is at or below threshold " + thresholdFormatted).setColor(Color.BLUE);
