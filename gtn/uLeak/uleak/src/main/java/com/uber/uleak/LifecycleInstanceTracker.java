...
class LifecycleInstanceTracker extends LeakTracker {
    ...
    LifecycleInstanceTracker(final Class clazz, final WeakReferenceGenerator weakReferenceGenerator, final String className) {
    ...
    boolean hasViolation() {
        ...
        return gcIndicatorWeakReference != null && gcIndicatorWeakReference.get() == null && isInMemory();
    }
