...
public enum NetworkPolicy {
  ...
  @Nullable public static boolean shouldReadFromDiskCache(@Nullable int networkPolicy) {
    return (networkPolicy & NetworkPolicy.NO_CACHE.index) == 0;
  }

  @Nullable public static boolean shouldWriteToDiskCache(int networkPolicy) {
    return (networkPolicy & NetworkPolicy.NO_STORE.index) == 0;
  }

  public static boolean isOfflineOnly(@Nullable int networkPolicy) {
