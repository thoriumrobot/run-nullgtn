...
public class RequestCreator {
   ...
   */
  @NonNull
  public RequestCreator placeholder(@DrawableRes @Nullable int placeholderResId) {
    if (!setPlaceholder) {
  ...
  /** An error drawable to be used if the request image could not be loaded. */
  @NonNull
  public RequestCreator error(@NonNull @Nullable Drawable errorDrawable) {
    if (errorDrawable == null) {
   ...
   */
  @NonNull
  public RequestCreator resizeDimen(@Nullable int targetWidthResId, @Nullable int targetHeightResId) {
   ...
   */
  @NonNull
  public RequestCreator centerCrop(@Nullable int alignGravity) {
  ...
  @NonNull
  public RequestCreator rotate(@Nullable float degrees, @Nullable float pivotX, @Nullable float pivotY) {
   ...
   */
  @NonNull
  public RequestCreator config(@NonNull @Nullable Bitmap.Config config) {
    data.config(config);
    return this;
  }
   ...
   */
  @NonNull
  public RequestCreator stableKey(@NonNull @Nullable String stableKey) {
   ...
   */
  @NonNull
  public RequestCreator priority(@NonNull @Nullable Priority priority) {
   ...
   */
  @NonNull
  public RequestCreator transform(@NonNull @Nullable List<? extends Transformation> transformations) {
   ...
   */
  @NonNull
  public RequestCreator memoryPolicy(@NonNull @Nullable MemoryPolicy policy,
      @NonNull @Nullable MemoryPolicy... additional) {
  ...
  public RequestCreator networkPolicy(@NonNull NetworkPolicy policy,
      @NonNull @Nullable NetworkPolicy... additional) {
