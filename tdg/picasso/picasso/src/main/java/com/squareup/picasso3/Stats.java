...
class Stats {
  @Nullable private static final int CACHE_HIT = 0;
  @Nullable private static final int CACHE_MISS = 1;
  @Nullable private static final int BITMAP_DECODE_FINISHED = 2;
  private static final int BITMAP_TRANSFORMED_FINISHED = 3;
  @Nullable private static final int DOWNLOAD_FINISHED = 4;

  @Nullable private static final String STATS_THREAD_NAME = Utils.THREAD_PREFIX + "Stats";
  ...
  long cacheHits;
  @Nullable long cacheMisses;
  long totalDownloadSize;
  long totalOriginalBitmapSize;
  long totalTransformedBitmapSize;
  long averageDownloadSize;
  @Nullable long averageOriginalBitmapSize;
  ...
  void dispatchBitmapDecoded(@Nullable Bitmap bitmap) {
  ...
  void dispatchDownloadFinished(@Nullable long size) {
  ...
  void performDownloadFinished(@Nullable Long size) {
    downloadCount++;
  ...
  void performBitmapTransformed(@Nullable long size) {
  ...
  private void processBitmap(Bitmap bitmap, @Nullable int what) {
  ...
  private static long getAverage(@Nullable int count, @Nullable long totalSize) {
  ...
  private static class StatsHandler extends Handler {
    ...
    @Override public void handleMessage(@Nullable final Message msg) {
      switch (msg.what) {
        case CACHE_HIT:
