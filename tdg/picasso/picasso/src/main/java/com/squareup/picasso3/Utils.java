...
final class Utils {
  ...
  */
  ...
  static String getLogIdsForHunter(BitmapHunter hunter, @Nullable String prefix) {
  ...
  static void log(@Nullable String owner, String verb, @Nullable String logId, @Nullable String extras) {
    if (extras == null) {
      extras = "";
    }
  ...
  static File createDefaultCacheDir(@Nullable Context context) {
  ...
  static long calculateDiskCacheSize(@Nullable File dir) {
  ...
  static int calculateMemoryCacheSize(@Nullable Context context) {
  ...
  @Nullable static boolean isAirplaneModeOn(Context context) {
  ...
  @Nullable static boolean hasPermission(@Nullable Context context, @Nullable String permission) {
    return context.checkCallingOrSelfPermission(permission) == PackageManager.PERMISSION_GRANTED;
  }

  @Nullable static boolean isWebPFile(BufferedSource source) throws IOException {
    return source.rangeEquals(0, WEBP_FILE_HEADER_RIFF)
        && source.rangeEquals(8, WEBP_FILE_HEADER_WEBP);
  }

  static int getResourceId(@Nullable Resources resources, Request data) throws FileNotFoundException {
  ...
  @Nullable static Resources getResources(@Nullable Context context, @Nullable Request data) throws FileNotFoundException {
    if (data.resourceId != 0 || data.uri == null) {
   ...
   */
  static void flushStackLocalLeaks(Looper @Nullable looper) {
