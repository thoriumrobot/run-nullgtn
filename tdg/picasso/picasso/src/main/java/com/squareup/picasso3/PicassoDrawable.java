...
final class PicassoDrawable extends BitmapDrawable {
   ...
   * image.
   */
  static void setResult(@Nullable ImageView target, @Nullable Context context, RequestHandler.Result result,
      @Nullable boolean noFade, @Nullable boolean debugging) {
  ...
  @Nullable private final boolean debugging;
  ...
  @Override public void draw(@Nullable Canvas canvas) {
    if (!animating) {
      super.draw(canvas);
    } else {
  ...
  private void drawDebugIndicator(@Nullable Canvas canvas) {
