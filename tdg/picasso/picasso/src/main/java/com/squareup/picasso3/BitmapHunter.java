...
class BitmapHunter implements Runnable {
  ...
  private static final AtomicInteger @Nullable SEQUENCE_GENERATOR = new AtomicInteger();
  ...
  final int sequence;
  final Picasso @Nullable picasso;
  final Dispatcher dispatcher;
  final PlatformLruCache @Nullable cache;
  final Stats @Nullable stats;
  final String @Nullable key;
  Request data;
  final RequestHandler requestHandler;

  @Nullable Action @Nullable action;
  @Nullable List<Action> @Nullable actions;
  @Nullable Result @Nullable result;
  @Nullable Future<?> future;
  @Nullable Exception @Nullable exception;
  int retryCount;
  Priority priority;
  ...
  Result hunt() throws IOException {
    ...
    try {
      requestHandler.load(picasso, data, new RequestHandler.Callback() {
        @Override public void onSuccess(@Nullable Result @Nullable result) {
...
if (bitmap != null) {
  ...
  void @Nullable attach(Action action) {
  ...
  void @Nullable detach(Action action) {
  ...
  private Priority computeNewPriority() {
    ...
    final boolean hasMultiple = actions != @Nullable null && !actions.isEmpty();
  ...
  boolean shouldRetry(boolean @Nullable airplaneMode, @Nullable NetworkInfo info) {
  ...
  @Nullable Result @Nullable getResult() {
    return result;
  }
  ...
  Request @Nullable getData() {
    return data;
  }

  @Nullable Action @Nullable getAction() {
    return action;
  }

  Picasso @Nullable getPicasso() {
    return picasso;
  }

  @Nullable List<Action> @Nullable getActions() {
    return actions;
  }

  @Nullable Exception @Nullable getException() {
    return exception;
  }
  ...
  static void updateThreadName(Request @Nullable data) {
  ...
  static BitmapHunter @Nullable forRequest(Picasso picasso, Dispatcher dispatcher,
      PlatformLruCache @Nullable cache, Stats stats, Action @Nullable action) {
    Request request = action.request;
  ...
  static Result applyTransformations(Picasso @Nullable picasso, Request data,
