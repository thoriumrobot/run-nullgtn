...
final class MatrixTransformation implements Transformation {
  ...
  @NonNull @Override public RequestHandler.Result transform(@NonNull @Nullable RequestHandler.Result source) {
  ...
  @VisibleForTesting
  @Nullable static Bitmap transformResult(@Nullable Request data, @Nullable Bitmap result, @Nullable int exifOrientation) {
  ...
  private static int getExifRotation(@Nullable int orientation) {
    int rotation;
    switch (orientation) {
  ...
  private static int getExifTranslation(@Nullable int orientation) {
    int translation;
    switch (orientation) {
