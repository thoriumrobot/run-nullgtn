...
public final class ResourceDrawableRequestHandler extends RequestHandler {
  ...
  @Override
  public void load(@NonNull @Nullable Picasso picasso, @NonNull Request request, @NonNull @Nullable Callback callback) {
  ...
  @NonNull
  public static ResourceDrawableRequestHandler create(@NonNull @Nullable final Context context) {
