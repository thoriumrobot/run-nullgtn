...
public final class Request {
   ...
   */
  @Nullable public final Uri @Nullable uri;
  /**
   * The image resource ID.
   * <p>
   * This is mutually exclusive with {@link #uri}.
   */
  public final int @Nullable resourceId;
  /**
  ...
  public final int @Nullable centerCropGravity;
  /**
  ...
  @Nullable public final Object @Nullable tag;
  ...
  @NonNull
  @Override public String @Nullable toString() {
  ...
  String @Nullable plainId() {
    return "[R" + id + ']';
  }

  String @Nullable getName() {
    if (uri != null) {
  ...
  boolean @Nullable needsMatrixTransform() {
  ...
  private String createKey(StringBuilder builder) {
    ...
    } else if (data.uri != @Nullable null) {
  ...
  public static final class Builder {
    @Nullable Uri uri;
    int @Nullable resourceId;
    @Nullable String @Nullable stableKey;
    int @Nullable targetWidth;
    int targetHeight;
    boolean @Nullable centerCrop;
    int centerCropGravity;
    boolean @Nullable centerInside;
    boolean onlyScaleDown;
    float rotationDegrees;
    float rotationPivotX;
    float rotationPivotY;
    boolean @Nullable hasRotationPivot;
    boolean @Nullable purgeable;
    @Nullable List<Transformation> transformations;
    @Nullable Bitmap.Config @Nullable config;
    @Nullable Priority priority;
    @Nullable Object tag;
    int @Nullable memoryPolicy;
    int @Nullable networkPolicy;
    ...
    boolean @Nullable hasImage() {
      return uri != null || resourceId != 0;
    }

    boolean @Nullable hasSize() {
      return targetWidth != 0 || targetHeight != 0;
    }

    boolean @Nullable hasPriority() {
     ...
     */
    @NonNull
    public Builder @Nullable setResourceId(@DrawableRes int @Nullable resourceId) {
      if (resourceId == 0) {
        throw new IllegalArgumentException("Image resource ID may not be 0.");
      }
      this.resourceId = resourceId;
      this.uri = @Nullable null;
      return this;
    }
     ...
     */
    @NonNull
    public Builder @Nullable stableKey(@Nullable String @Nullable stableKey) {
    ...
    /** Internal use only. Used by {@link DeferredRequestCreator}. */
    @Nullable Object @Nullable getTag() {
      return tag;
    }
     ...
     */
    @NonNull
    public Builder @Nullable centerCrop(int @Nullable alignGravity) {
      if (centerInside) {
    ...
    @NonNull
    public Builder @Nullable clearCenterCrop() {
      centerCrop = false;
    ...
    @NonNull
    public Builder @Nullable clearCenterInside() {
      centerInside = false;
      return this;
    }
     ...
     */
    @NonNull
    public Builder @Nullable onlyScaleDown() {
      if (targetHeight == 0 && targetWidth == 0) {
    ...
    @NonNull
    public Builder @Nullable clearOnlyScaleDown() {
      onlyScaleDown = false;
      return this;
    }
    ...
    @NonNull
    public Builder @Nullable rotate(float degrees, float pivotX, float @Nullable pivotY) {
      rotationDegrees = degrees;
    ...
    @NonNull
    public Builder @Nullable clearRotation() {
      rotationDegrees = 0;
      rotationPivotX = 0;
      rotationPivotY = 0;
    ...
    @NonNull
    public Builder @Nullable priority(@NonNull Priority @Nullable priority) {
     ...
     */
    @NonNull
    public Builder transform(@NonNull Transformation @Nullable transformation) {
     ...
     */
    @NonNull
    public Builder @Nullable networkPolicy(@NonNull NetworkPolicy policy,
        @NonNull NetworkPolicy... @Nullable additional) {
      if (policy == null) {
        throw new NullPointerException("policy == null");
      }
      ...
      for (NetworkPolicy networkPolicy : additional) {
        if (networkPolicy == @Nullable null) {
          throw new NullPointerException("additional[i] == null");
        }
