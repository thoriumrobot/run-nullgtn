...
class ContactsPhotoRequestHandler extends RequestHandler {
  ...
  @Nullable private static final int ID_THUMBNAIL = 2;
  /** A contact uri (e.g. content://com.android.contacts/contacts/38) */
  @Nullable private static final int ID_CONTACT = 3;
  /**
  ...
  @Override @Nullable public boolean canHandleRequest(@NonNull Request data) {
  ...
  @Override
  public void load(@NonNull @Nullable Picasso picasso, @NonNull Request request, @NonNull Callback callback) {
  ...
  @Nullable private Source getSource(@Nullable Uri uri) throws IOException {
