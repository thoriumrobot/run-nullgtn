...
interface LinkedDeque<E> extends Deque<E> {
    ...
    interface PeekingIterator<E> extends Iterator<E> {
         ...
         */
        static <E> PeekingIterator<E> concat(PeekingIterator<E> first, @Nullable PeekingIterator<E> second) {
         ...
         */
        static <E> PeekingIterator<E> comparing(PeekingIterator<E> first, PeekingIterator<E> second, @Nullable Comparator<E> comparator) {
            return new PeekingIterator<E>() {
