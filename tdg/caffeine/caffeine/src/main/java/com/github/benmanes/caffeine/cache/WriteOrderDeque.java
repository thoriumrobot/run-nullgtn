...
final class WriteOrderDeque<E extends WriteOrder<E>> extends AbstractLinkedDeque<E> {
    ...
    @Nullable boolean contains(WriteOrder<?> e) {
    ...
    @Override
    @Nullable public E getPrevious(@Nullable E e) {
        return e.getPreviousInWriteOrder();
    }

    @Override
    public void setPrevious(@Nullable E e, @Nullable E prev) {
        e.setPreviousInWriteOrder(prev);
    }

    @Override
    @Nullable public E getNext(E e) {
        return e.getNextInWriteOrder();
    }

    @Override
    public void setNext(@Nullable E e, @Nullable E next) {
