...
public final class CaffeineSpec {
    ...
    long @Nullable refreshAfterWriteDuration = UNSET_INT;
     ...
     */
    Caffeine<Object, Object> @Nullable toBuilder() {
     ...
     */
    void @Nullable parseOption(String @Nullable option) {
        if (option.isEmpty()) {
            return;
        }
        @SuppressWarnings("StringSplitter")
        ...
        String value = (keyAndValue.length == 1) ? @Nullable null : keyAndValue[1].trim();
        configure(key, value);
    }
     ...
     */
    void configure(String @Nullable key, @Nullable String @Nullable value) {
        switch(key) {
     ...
     */
    void maximumSize(String @Nullable key, @Nullable String value) {
     ...
     * Configures the maximum size.
     */
    void maximumWeight(String @Nullable key, @Nullable String value) {
        requireArgument(maximumWeight == UNSET_INT, "maximum weight was already set to %,d", maximumWeight);
        requireArgument(maximumSize == UNSET_INT, "maximum size was already set to %,d", maximumSize);
     ...
     */
    void @Nullable weakKeys(@Nullable String value) {
     ...
     */
    void @Nullable valueStrength(String @Nullable key, @Nullable String @Nullable value, Strength strength) {
        requireArgument(value == null, "%s does not take a value", key);
        requireArgument(valueStrength == @Nullable null, "%s was already set to %s", key, valueStrength);
     ...
     */
    void expireAfterWrite(String @Nullable key, @Nullable String value) {
     ...
     */
    void @Nullable refreshAfterWrite(String key, @Nullable String @Nullable value) {
     ...
     * Configures the value as weak or soft references.
     */
    void recordStats(@Nullable String @Nullable value) {
     ...
     */
    static int parseInt(String @Nullable key, @Nullable String value) {
     ...
     */
    static long @Nullable parseLong(String key, @Nullable String value) {
        requireArgument((value != null) && !value.isEmpty(), "value of key %s was omitted", key);
        try {
     ...
     */
    static long parseDuration(String @Nullable key, @Nullable String @Nullable value) {
     ...
     */
    static TimeUnit @Nullable parseTimeUnit(String @Nullable key, @Nullable String @Nullable value) {
        requireArgument((value != null) && !value.isEmpty(), "value of key %s omitted", key);
        @SuppressWarnings("NullAway")
    ...
    @Override
    public b@Nullable o@Nullable olean equals(Object @Nullable o) {
        if (this == o) {
            return true;
     ...
     */
    static long @Nullable durationInNanos(long @Nullable duration, @Nullable TimeUnit @Nullable unit) {
        return (unit == @Nullable null) ? UNSET_INT : unit.toNanos(duration);
    }
     ...
     */
    @Override
    public String @Nullable toString() {
