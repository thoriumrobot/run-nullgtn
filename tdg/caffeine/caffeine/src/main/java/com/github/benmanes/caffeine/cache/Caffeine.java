...
public final class Caffeine<K, V> {
     ...
     */
    @NonNull
@Nullable Caffeine<K, V> weakKeys() {
     ...
     */
    @NonNull
    public Caffeine<K, V> @Nullable expireAfterWrite(@NonNegative long duration, @NonNull TimeUnit unit) {
     ...
     */
    @NonNull
    public <K1 extends K, V1 extends V> LoadingCache<K1, V1> @Nullable build(@NonNull CacheLoader<? super K1, V1> loader) {
        requireWeightWithWeigher();
        @SuppressWarnings("unchecked")
        Caffeine<K1, V1> self = (Caffeine<K1, V1>) this;
