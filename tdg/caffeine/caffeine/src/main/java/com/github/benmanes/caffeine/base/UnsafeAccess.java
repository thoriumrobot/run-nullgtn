...
public final class UnsafeAccess {
    ...
    @Nullable static final String ANDROID = "THE_ONE";
     ...
     */
    public static long objectFieldOffset(@Nullable Class<?> clazz, @Nullable String fieldName) {
        try {
    ...
    @Nullable static Unsafe load(String openJdk, @Nullable String android) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
        Field field;
        try {
