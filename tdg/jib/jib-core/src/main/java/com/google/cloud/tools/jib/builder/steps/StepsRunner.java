...
public class StepsRunner {
    ...
    private static class Steps {
        ...
        @Nullable private ImmutableList<BuildAndCacheApplicationLayerStep> buildAndCacheApplicationLayerSteps;
    ...
    @Nullable BuildResult run() throws ExecutionException, InterruptedException {
