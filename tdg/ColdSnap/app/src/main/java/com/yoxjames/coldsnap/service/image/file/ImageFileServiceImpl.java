...
public class ImageFileServiceImpl implements ImageFileService {
    ...
    @Override
    @Nullable Observable<ActionReply> deleteImageFile(String fileName, Context context) {
        return Observable.create((ObservableEmitter<ActionReply> e) -> {
            File image = new File(fileName);
            Uri photoURI = FileProvider.getUriForFile(context, "com.yoxjames.coldsnap.provider", image);
